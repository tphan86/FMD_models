%% figure 1: delta > delta_star, theta < theta_star, small noises
...
theta = 0.01;  % progression rate from latently infected to infectious
varpi = 0.14;  % immunity recovery rate of infectious
...
S0 = round(EE(1,1),2) + 1E4;
V0 = round(EE(1,2),2) + 1E5;
E0 = round(EE(1,3),2) + 1E1;
I0 = round(EE(1,4),2) + 1E1;
R0 = round(EE(1,5),2) + 1E5;
